...
/*--------------------------------------------------------------------- 
 * Method: sr_get_interface_from_mac(..)
 * Scope: Global
 *
 * Custom: Get the interface based on MAC address 
 *
 *---------------------------------------------------------------------*/
struct sr_if* sr_get_interface_from_mac(struct sr_instance* sr, unsigned char* addr) {
    assert(sr);
    assert(addr);
 ...
 * Scope: Global
 *
 * Custom: Get the interface based on ip 
 *
 *---------------------------------------------------------------------*/
